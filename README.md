...
docker build -t webresto/docker-cordova:%tag% .
docker push -t webresto/docker-cordova:%tag% 
...
# sdkmanager --list
  ...
  -------                                     | ------- | -------                                    | -------
  build-tools;30.0.2                          | 33.0.2  | Android SDK Build-Tools 33.0.2             | build-tools/33.0.2/
